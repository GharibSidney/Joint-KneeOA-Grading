...
- `kxr_sq_bu00.txt`: A file containing the Kellgren-Lawrence (KL) grades and OARSI grades for each radiograph (e.g., kxr_sq_bu00.txt from the OAI dataset). Where "k" stands for knee, "XR" stands for x-ray, "SQ" stands for semi-quantitative, "BU" stands for researchers name and "00" is the baseline timeline. 
