...
def load_labels(label_file):
    ...
    for _, row in df.iterrows():
        ...
        labels[key] = {
            "kl_L": process_value(row.get("V0XLKL")),
            "kl_R":process_value(row.get("V0XRKL")),

            "osteophyte_femur_lateral_L":  process_value(row.get("V0XLOSFL")),
            "joint_space_lateral_L":       process_value(row.get("V0XLJSL")),
            "osteophyte_tibia_lateral_L":  process_value(row.get("V0XLOSTL")),
            "osteophyte_femur_medial_L":   process_value(row.get("V0XLOSFM")),
            "joint_space_medial_L":        process_value(row.get("V0XLJSM")),
            "osteophyte_tibia_medial_L":   process_value(row.get("V0XLOSTM")),

            "osteophyte_femur_lateral_R":  process_value(row.get("V0XROSFL")),
            "joint_space_lateral_R":       process_value(row.get("V0XRJSL")),
            "osteophyte_tibia_lateral_R":  process_value(row.get("V0XROSTL")),
            "osteophyte_femur_medial_R":   process_value(row.get("V0XROSFM")),
            "joint_space_medial_R":        process_value(row.get("V0XRJSM")),
            "osteophyte_tibia_medial_R":   process_value(row.get("V0XROSTM")),
        }
    return labels
...
def main():
    ...
    osteophyte_femur_lateral_L_list,  osteophyte_femur_lateral_R_list  = [], []
    joint_space_lateral_L_list,       joint_space_lateral_R_list       = [], []
    osteophyte_tibia_lateral_L_list,  osteophyte_tibia_lateral_R_list  = [], []
    osteophyte_femur_medial_L_list,   osteophyte_femur_medial_R_list   = [], []
    joint_space_medial_L_list,        joint_space_medial_R_list        = [], []
    osteophyte_tibia_medial_L_list,   osteophyte_tibia_medial_R_list   = [], []
    ...
    for rec in records:
        ...
        osteophyte_femur_lateral_L_list.append(label_entry.get("osteophyte_femur_lateral_L", -999))
        osteophyte_femur_lateral_R_list.append(label_entry.get("osteophyte_femur_lateral_R", -999))
        joint_space_lateral_L_list.append(label_entry.get("joint_space_lateral_L",           -999))
        joint_space_lateral_R_list.append(label_entry.get("joint_space_lateral_R",           -999))
        osteophyte_tibia_lateral_L_list.append(label_entry.get("osteophyte_tibia_lateral_L", -999))
        osteophyte_tibia_lateral_R_list.append(label_entry.get("osteophyte_tibia_lateral_R", -999))
        osteophyte_femur_medial_L_list.append(label_entry.get("osteophyte_femur_medial_L",   -999))
        osteophyte_femur_medial_R_list.append(label_entry.get("osteophyte_femur_medial_R",   -999))
        joint_space_medial_L_list.append(label_entry.get("joint_space_medial_L",             -999))
        joint_space_medial_R_list.append(label_entry.get("joint_space_medial_R",             -999))
        osteophyte_tibia_medial_L_list.append(label_entry.get("osteophyte_tibia_medial_L",   -999))
        osteophyte_tibia_medial_R_list.append(label_entry.get("osteophyte_tibia_medial_R",   -999))

    print(f"\nCollected {len(subject_ids)} valid records.")
    shapes_L_np  = np.array(shapes_L_list)
